...
from matriculas.views import home, listarMatriculados, cadastrarMatricula, editarMatricula, deletarMatricula, matriculaCadastrada
...
urlpatterns = [
    ...
    path('matriculaCadastrada/', matriculaCadastrada, name='url_cadastrada'),
]
